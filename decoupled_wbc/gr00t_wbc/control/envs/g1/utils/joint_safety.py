...
class JointSafetyMonitor:
    ...
    ARM_VELOCITY_LIMIT = 10.0  # rad/s for arm joints (increased from 6.0)
    HAND_VELOCITY_LIMIT = 80.0  # rad/s for finger joints (increased from 50.0)
    ...
    def __init__(self, robot_model, enable_viz: bool = False, env_type: str = "real"):
        ...
        self.safety_margin = 1.4  # Hardcoded safety margin (increased from 1.0 for looser limits)
